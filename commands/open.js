...
class PingCommand extends Command {
  ...
  registerApplicationCommands(registry) {
    registry.registerChatInputCommand((builder) =>
      builder.setName("open").setDescription("Opens a new ticket")
      .addStringOption(option => 
        option.setName('name')
        .setDescription('The name of the ticket type to open')
        .setMaxLength(12)
        .setRequired(true)
  ...
  async chatInputRun(interaction) {
    ...
    const ticketType = interaction.options.getString('name');
